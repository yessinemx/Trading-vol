"""Shared pytest fixtures with synthetic market data for fast, offline tests."""
...
@pytest.fixture
def small_surface() -> VolSurface:
    """A minimal 2-maturity vol surface with a simple smile."""
    rows = []
...
@pytest.fixture
def flat_curve() -> CurveInterpolator:
    """A simple upward-sloping flat-ish rate curve."""
...
@pytest.fixture
def spot() -> float:
    """Synthetic EUR/NOK spot."""
    return 11.50


@pytest.fixture
def synthetic_spot_series() -> pd.Series:
    """250 business days of a random-walk spot series around 11.50 NOK."""
